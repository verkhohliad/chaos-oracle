...
class WorkerConfig(BaseSettings):
    """Configuration for the ChaosOracle Worker agent.
    ...
    worker_private_key: str = Field(
        ...,
        description="Hex-encoded private key for the worker agent wallet.",
    )
    ...
    arweave_wallet_path: str = Field(
        default="",
        description="Path to Arweave JWK wallet file. Empty = use stub CID.",
    )
